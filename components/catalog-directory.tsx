  ...
  return (
    <section className={styles.directory}>
      <header className={styles.hero}>
        <div>
          <span>PUBLIC MARKET DIRECTORY</span>
          <h1>Everything agents can discover.</h1>
          <p>
            Places, seats and services currently listed across Lisbon.
            Only public market metadata is shown.
          </p>
        </div>
      ...
      <div className={styles.catalogControls}>
        <div>
          ...
          <strong>{visibleListings.length} available now</strong>
        </div>
      ...
      <footer className={styles.directoryNote}>
        ...
        Seller floors, salts, demand parameters and buyer mandates remain
        private.
      </footer>
    </section>
  );
